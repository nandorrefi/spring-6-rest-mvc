...
class BeerControllerTest {
    ...
    void testUpdateBeerEmptyUpc() throws Exception {
        ...
        UUID beerId = beerServiceImpl.listBeers(null, null).getFirst().getId();
        given(beerService.updateBeerById(eq(beerId), any(BeerDTO.class))).willReturn(Optional.of(beerServiceImpl.listBeers(null, null).getFirst()));
    ...
    void testPatchBeer() throws Exception {
        BeerDTO beer = beerServiceImpl.listBeers(null, null).getFirst();
